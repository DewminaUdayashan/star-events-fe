...
export default function EditEventPage({ params }: { params: { id: string } }) {
    ...
    const loadEvent = async () => {
      try {
        ...
        const mockEvent = {
          ...
          description:
            "Join us for an unforgettable night of electronic music featuring top DJs from around the world. Experience cutting-edge sound and lighting in an incredible atmosphere.",
          category: "music",
          ...
          prices: [
            ...
            },
            {
              ...
              price: 12000,
              stock: 200,
              description: "VIP access with exclusive areas",
            },
          ],
          isPublished: true,
        };
        ...
        setFormData({
          ...
          venueName: mockEvent.venueName,
          venueLocation: mockEvent.venueLocation,
          venueCapacity: mockEvent.venueCapacity,
          image: mockEvent.image,
          prices: mockEvent.prices,
          isPublished: mockEvent.isPublished,
        });
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Updating event:", { id: params.id, ...formData });
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="publish" className="text-white">
                      Event is published (visible to customers)
                    </Label>
                  </div>
