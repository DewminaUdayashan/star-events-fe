        ...
        {events.length > 0 ? (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex space-x-2">
                    ...
                    {event.featured && <Badge className="bg-yellow-600 hover:bg-yellow-700">Featured</Badge>}
                  </div>
                  {event.discount && (
          ...
          <div className="text-center py-12">
            <div className="text-gray-400 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-2">No events in this category yet</h3>
              <p>Check back later for new {category.name.toLowerCase()} events.</p>
            </div>
            <Link href="/events">
              <Button
                variant="outline"
